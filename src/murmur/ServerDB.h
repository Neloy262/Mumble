...
public:
	...
	static void setUPW(int iServNum, const QString &pw,int id,const QString &name);
...
private:
	...
	static void writeUPW(int srvnum, const QString &pwHash, const QString &saltHash, const QVariant &kdfIterations,int id,const QString &name);
