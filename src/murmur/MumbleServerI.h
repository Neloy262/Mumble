...
public:
	...
	virtual void AddUserToChannel_async(const ::MumbleServer::AMD_Server_AddUserToChannelPtr &cb, const UserList& p1, const ChannelIds& p3, ::Ice::Int p4, const ::Ice::Current &current);
