...
#include "../../../../../src/mumble/TextMessage.h"
...
QT_MOC_LITERAL(1, 12, 30), // "on_qcbTreeMessage_stateChanged"
QT_MOC_LITERAL(2, 43, 0) // ""

    },
    "TextMessage\0on_qcbTreeMessage_stateChanged\0"
    ""
};
...
void TextMessage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TextMessage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_qcbTreeMessage_stateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject TextMessage::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_TextMessage.data,
    qt_meta_data_TextMessage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TextMessage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::TextMessage"))
        return static_cast< Ui::TextMessage*>(this);
