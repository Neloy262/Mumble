...
#include "../../../../../src/mumble/UserModel.h"
...
QT_MOC_LITERAL(16, 227, 21), // "toggleChannelFiltered"
QT_MOC_LITERAL(17, 249, 8), // "Channel*"
QT_MOC_LITERAL(18, 258, 1) // "c"
    ...
    "toggleChannelFiltered\0Channel*\0c"
};
...
static const uint qt_meta_data_UserModel[] = {
 ...
 // slots: parameters
    QMetaType::Void,
    QMetaType::Void, QMetaType::Int, QMetaType::Float, QMetaType::Float,    6,   11,   12,
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void,
...
void UserModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->channelAdded((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->channelRemoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->channelRenamed((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->userStateChanged(); break;
        case 6: _t->on_channelListenerLocalVolumeAdjustmentChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2])),(*reinterpret_cast< float(*)>(_a[3]))); break;
        case 7: _t->ensureSelfVisible(); break;
        case 8: _t->recheckLinks(); break;
        case 9: _t->updateOverlay(); break;
        case 10: _t->toggleChannelFiltered((*reinterpret_cast< Channel*(*)>(_a[1]))); break;
        default: ;
        }
...
// SIGNAL 2
void UserModel::channelAdded(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void UserModel::channelRemoved(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 4
void UserModel::channelRenamed(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
