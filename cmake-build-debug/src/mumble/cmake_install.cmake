...
if(CMAKE_INSTALL_COMPONENT STREQUAL "mumble_client" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/mumble" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/mumble")
    endif()
  endif()
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "mumble_client" OR NOT CMAKE_INSTALL_COMPONENT)
  foreach(file
      ...
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mumble/libopus.so.0"
      )
    if(EXISTS "${file}" AND
       NOT IS_SYMLINK "${file}")
      file(RPATH_CHECK
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "mumble_client" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mumble/libopus.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mumble/libopus.so")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mumble/libopus.so")
    endif()
  endif()
endif()
