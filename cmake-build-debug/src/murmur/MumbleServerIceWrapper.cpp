// This file was auto-generated by scripts/generateIceWrapper.py on 2023-01-29 -- DO NOT EDIT MANUALLY!
...
void ::MumbleServer::ServerI::AddUserToChannel_async(const ::MumbleServer::AMD_Server_AddUserToChannelPtr &cb, const UserList& p1, const ChannelIds& p2, ::Ice::Int p3, const ::Ice::Current &current) {
...
#	endif // ACCESS_Server_AddUserToChannel_READ
	...
	ExecEvent *ie = new ExecEvent(boost::bind(&impl_Server_AddUserToChannel, cb, QString::fromStdString(current.id.name).toInt(), p1, p2, p3));
	QCoreApplication::instance()->postEvent(mi, ie);
}
