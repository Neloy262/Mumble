// This file was auto-generated by scripts/generateIceWrapper.py on 2023-01-25 -- DO NOT EDIT MANUALLY!

#include <boost/bind/bind.hpp>

void ::MumbleServer::ServerI::isRunning_async(const ::MumbleServer::AMD_Server_isRunningPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::start_async(const ::MumbleServer::AMD_Server_startPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::helloIce_async(const ::MumbleServer::AMD_Server_helloIcePtr &cb, const ::Ice::Current &current) {
	// qWarning() << "helloIce" << meta->mp.qsIceSecretRead.isNull() << meta->mp.qsIceSecretRead.isEmpty();
#ifndef ACCESS_Server_helloIce_ALL
#	ifdef ACCESS_Server_helloIce_READ
	if (!meta->mp.qsIceSecretRead.isNull()) {
		bool ok = !meta->mp.qsIceSecretRead.isEmpty();
#	else
	if (!meta->mp.qsIceSecretRead.isNull() || !meta->mp.qsIceSecretWrite.isNull()) {
		bool ok = !meta->mp.qsIceSecretWrite.isEmpty();
#	endif // ACCESS_Server_helloIce_READ
		::Ice::Context::const_iterator i = current.ctx.find("secret");
		ok = ok && (i != current.ctx.end());
		if (ok) {
			const QString &secret = u8((*i).second);
...
#endif // ACCESS_Server_helloIce_ALL

	ExecEvent *ie = new ExecEvent(boost::bind(&impl_Server_helloIce, cb, QString::fromStdString(current.id.name).toInt()));
	QCoreApplication::instance()->postEvent(mi, ie);
}

void ::MumbleServer::ServerI::AddUserToChannel_async(const ::MumbleServer::AMD_Server_AddUserToChannelPtr &cb, const UserList& p1, const ChannelList& p2, const ChannelIds& p3, ::Ice::Int p4, const ::Ice::Current &current) {
	// qWarning() << "AddUserToChannel" << meta->mp.qsIceSecretRead.isNull() << meta->mp.qsIceSecretRead.isEmpty();
#ifndef ACCESS_Server_AddUserToChannel_ALL
#	ifdef ACCESS_Server_AddUserToChannel_READ
	if (!meta->mp.qsIceSecretRead.isNull()) {
		bool ok = !meta->mp.qsIceSecretRead.isEmpty();
#	else
	if (!meta->mp.qsIceSecretRead.isNull() || !meta->mp.qsIceSecretWrite.isNull()) {
		bool ok = !meta->mp.qsIceSecretWrite.isEmpty();
#	endif // ACCESS_Server_AddUserToChannel_READ
		::Ice::Context::const_iterator i = current.ctx.find("secret");
		ok = ok && (i != current.ctx.end());
		if (ok) {
			const QString &secret = u8((*i).second);
...
#endif // ACCESS_Server_AddUserToChannel_ALL

	ExecEvent *ie = new ExecEvent(boost::bind(&impl_Server_AddUserToChannel, cb, QString::fromStdString(current.id.name).toInt(), p1, p2, p3, p4));
	QCoreApplication::instance()->postEvent(mi, ie);
}

void ::MumbleServer::ServerI::createGroup_async(const ::MumbleServer::AMD_Server_createGroupPtr &cb, const ::std::string& p1, const ::Ice::Current &current) {
	// qWarning() << "createGroup" << meta->mp.qsIceSecretRead.isNull() << meta->mp.qsIceSecretRead.isEmpty();
#ifndef ACCESS_Server_createGroup_ALL
#	ifdef ACCESS_Server_createGroup_READ
	if (!meta->mp.qsIceSecretRead.isNull()) {
		bool ok = !meta->mp.qsIceSecretRead.isEmpty();
#	else
	if (!meta->mp.qsIceSecretRead.isNull() || !meta->mp.qsIceSecretWrite.isNull()) {
		bool ok = !meta->mp.qsIceSecretWrite.isEmpty();
#	endif // ACCESS_Server_createGroup_READ
		::Ice::Context::const_iterator i = current.ctx.find("secret");
		ok = ok && (i != current.ctx.end());
		if (ok) {
			const QString &secret = u8((*i).second);
...
#endif // ACCESS_Server_createGroup_ALL

	ExecEvent *ie = new ExecEvent(boost::bind(&impl_Server_createGroup, cb, QString::fromStdString(current.id.name).toInt(), p1));
	QCoreApplication::instance()->postEvent(mi, ie);
}

void ::MumbleServer::ServerI::addChannelsToGroup_async(const ::MumbleServer::AMD_Server_addChannelsToGroupPtr &cb, const ChannelIds& p1, ::Ice::Int p2, const ::Ice::Current &current) {
	// qWarning() << "addChannelsToGroup" << meta->mp.qsIceSecretRead.isNull() << meta->mp.qsIceSecretRead.isEmpty();
#ifndef ACCESS_Server_addChannelsToGroup_ALL
#	ifdef ACCESS_Server_addChannelsToGroup_READ
	if (!meta->mp.qsIceSecretRead.isNull()) {
		bool ok = !meta->mp.qsIceSecretRead.isEmpty();
#	else
	if (!meta->mp.qsIceSecretRead.isNull() || !meta->mp.qsIceSecretWrite.isNull()) {
		bool ok = !meta->mp.qsIceSecretWrite.isEmpty();
#	endif // ACCESS_Server_addChannelsToGroup_READ
		::Ice::Context::const_iterator i = current.ctx.find("secret");
		ok = ok && (i != current.ctx.end());
		if (ok) {
			const QString &secret = u8((*i).second);
...
#endif // ACCESS_Server_addChannelsToGroup_ALL

	ExecEvent *ie = new ExecEvent(boost::bind(&impl_Server_addChannelsToGroup, cb, QString::fromStdString(current.id.name).toInt(), p1, p2));
	QCoreApplication::instance()->postEvent(mi, ie);
}

void ::MumbleServer::ServerI::addUsersToGroup_async(const ::MumbleServer::AMD_Server_addUsersToGroupPtr &cb, const UserIdList& p1, ::Ice::Int p2, const ::Ice::Current &current) {
	// qWarning() << "addUsersToGroup" << meta->mp.qsIceSecretRead.isNull() << meta->mp.qsIceSecretRead.isEmpty();
#ifndef ACCESS_Server_addUsersToGroup_ALL
#	ifdef ACCESS_Server_addUsersToGroup_READ
	if (!meta->mp.qsIceSecretRead.isNull()) {
		bool ok = !meta->mp.qsIceSecretRead.isEmpty();
#	else
	if (!meta->mp.qsIceSecretRead.isNull() || !meta->mp.qsIceSecretWrite.isNull()) {
		bool ok = !meta->mp.qsIceSecretWrite.isEmpty();
#	endif // ACCESS_Server_addUsersToGroup_READ
		::Ice::Context::const_iterator i = current.ctx.find("secret");
		ok = ok && (i != current.ctx.end());
		if (ok) {
			const QString &secret = u8((*i).second);
...
#endif // ACCESS_Server_addUsersToGroup_ALL

	ExecEvent *ie = new ExecEvent(boost::bind(&impl_Server_addUsersToGroup, cb, QString::fromStdString(current.id.name).toInt(), p1, p2));
	QCoreApplication::instance()->postEvent(mi, ie);
}

void ::MumbleServer::ServerI::stop_async(const ::MumbleServer::AMD_Server_stopPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::delete_async(const ::MumbleServer::AMD_Server_deletePtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::id_async(const ::MumbleServer::AMD_Server_idPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::addCallback_async(const ::MumbleServer::AMD_Server_addCallbackPtr &cb, const ServerCallbackPrx& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::removeCallback_async(const ::MumbleServer::AMD_Server_removeCallbackPtr &cb, const ServerCallbackPrx& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::setAuthenticator_async(const ::MumbleServer::AMD_Server_setAuthenticatorPtr &cb, const ServerAuthenticatorPrx& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getConf_async(const ::MumbleServer::AMD_Server_getConfPtr &cb, const ::std::string& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getAllConf_async(const ::MumbleServer::AMD_Server_getAllConfPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::setConf_async(const ::MumbleServer::AMD_Server_setConfPtr &cb, const ::std::string& p1, const ::std::string& p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::setSuperuserPassword_async(const ::MumbleServer::AMD_Server_setSuperuserPasswordPtr &cb, const ::std::string& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getLog_async(const ::MumbleServer::AMD_Server_getLogPtr &cb, ::Ice::Int p1, ::Ice::Int p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getLogLen_async(const ::MumbleServer::AMD_Server_getLogLenPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getUsers_async(const ::MumbleServer::AMD_Server_getUsersPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getChannels_async(const ::MumbleServer::AMD_Server_getChannelsPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getCertificateList_async(const ::MumbleServer::AMD_Server_getCertificateListPtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getTree_async(const ::MumbleServer::AMD_Server_getTreePtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getBans_async(const ::MumbleServer::AMD_Server_getBansPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::setBans_async(const ::MumbleServer::AMD_Server_setBansPtr &cb, const BanList& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::kickUser_async(const ::MumbleServer::AMD_Server_kickUserPtr &cb, ::Ice::Int p1, const ::std::string& p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getState_async(const ::MumbleServer::AMD_Server_getStatePtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::setState_async(const ::MumbleServer::AMD_Server_setStatePtr &cb, const User& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::sendMessage_async(const ::MumbleServer::AMD_Server_sendMessagePtr &cb, ::Ice::Int p1, const ::std::string& p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::hasPermission_async(const ::MumbleServer::AMD_Server_hasPermissionPtr &cb, ::Ice::Int p1, ::Ice::Int p2, ::Ice::Int p3, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::effectivePermissions_async(const ::MumbleServer::AMD_Server_effectivePermissionsPtr &cb, ::Ice::Int p1, ::Ice::Int p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::addContextCallback_async(const ::MumbleServer::AMD_Server_addContextCallbackPtr &cb, ::Ice::Int p1, const ::std::string& p2, const ::std::string& p3, const ServerContextCallbackPrx& p4, ::Ice::Int p5, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::removeContextCallback_async(const ::MumbleServer::AMD_Server_removeContextCallbackPtr &cb, const ServerContextCallbackPrx& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getChannelState_async(const ::MumbleServer::AMD_Server_getChannelStatePtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::setChannelState_async(const ::MumbleServer::AMD_Server_setChannelStatePtr &cb, const Channel& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::removeChannel_async(const ::MumbleServer::AMD_Server_removeChannelPtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::addChannel_async(const ::MumbleServer::AMD_Server_addChannelPtr &cb, const ::std::string& p1, ::Ice::Int p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::sendMessageChannel_async(const ::MumbleServer::AMD_Server_sendMessageChannelPtr &cb, ::Ice::Int p1, bool p2, const ::std::string& p3, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getACL_async(const ::MumbleServer::AMD_Server_getACLPtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::setACL_async(const ::MumbleServer::AMD_Server_setACLPtr &cb, ::Ice::Int p1, const ACLList& p2, const GroupList& p3, bool p4, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::addUserToGroup_async(const ::MumbleServer::AMD_Server_addUserToGroupPtr &cb, ::Ice::Int p1, ::Ice::Int p2, const ::std::string& p3, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::removeUserFromGroup_async(const ::MumbleServer::AMD_Server_removeUserFromGroupPtr &cb, ::Ice::Int p1, ::Ice::Int p2, const ::std::string& p3, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::redirectWhisperGroup_async(const ::MumbleServer::AMD_Server_redirectWhisperGroupPtr &cb, ::Ice::Int p1, const ::std::string& p2, const ::std::string& p3, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getUserNames_async(const ::MumbleServer::AMD_Server_getUserNamesPtr &cb, const IdList& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getUserIds_async(const ::MumbleServer::AMD_Server_getUserIdsPtr &cb, const NameList& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::registerUser_async(const ::MumbleServer::AMD_Server_registerUserPtr &cb, const UserInfoMap& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::unregisterUser_async(const ::MumbleServer::AMD_Server_unregisterUserPtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::updateRegistration_async(const ::MumbleServer::AMD_Server_updateRegistrationPtr &cb, ::Ice::Int p1, const UserInfoMap& p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getRegistration_async(const ::MumbleServer::AMD_Server_getRegistrationPtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getRegisteredUsers_async(const ::MumbleServer::AMD_Server_getRegisteredUsersPtr &cb, const ::std::string& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::verifyPassword_async(const ::MumbleServer::AMD_Server_verifyPasswordPtr &cb, const ::std::string& p1, const ::std::string& p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getTexture_async(const ::MumbleServer::AMD_Server_getTexturePtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::setTexture_async(const ::MumbleServer::AMD_Server_setTexturePtr &cb, ::Ice::Int p1, const Texture& p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getUptime_async(const ::MumbleServer::AMD_Server_getUptimePtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::updateCertificate_async(const ::MumbleServer::AMD_Server_updateCertificatePtr &cb, const ::std::string& p1, const ::std::string& p2, const ::std::string& p3, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::startListening_async(const ::MumbleServer::AMD_Server_startListeningPtr &cb, ::Ice::Int p1, ::Ice::Int p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::stopListening_async(const ::MumbleServer::AMD_Server_stopListeningPtr &cb, ::Ice::Int p1, ::Ice::Int p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::isListening_async(const ::MumbleServer::AMD_Server_isListeningPtr &cb, ::Ice::Int p1, ::Ice::Int p2, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getListeningChannels_async(const ::MumbleServer::AMD_Server_getListeningChannelsPtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getListeningUsers_async(const ::MumbleServer::AMD_Server_getListeningUsersPtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::ServerI::getListenerVolumeAdjustment_async(const ::MumbleServer::AMD_Server_getListenerVolumeAdjustmentPtr &cb, ::Ice::Int p1, ::Ice::Int p2, const ::Ice::Current &current) {
	// qWarning() << "getListenerVolumeAdjustment" << meta->mp.qsIceSecretRead.isNull() << meta->mp.qsIceSecretRead.isEmpty();
#ifndef ACCESS_Server_getListenerVolumeAdjustment_ALL
#	ifdef ACCESS_Server_getListenerVolumeAdjustment_READ
	if (!meta->mp.qsIceSecretRead.isNull()) {
		bool ok = !meta->mp.qsIceSecretRead.isEmpty();
#	else
	if (!meta->mp.qsIceSecretRead.isNull() || !meta->mp.qsIceSecretWrite.isNull()) {
		bool ok = !meta->mp.qsIceSecretWrite.isEmpty();
#	endif // ACCESS_Server_getListenerVolumeAdjustment_READ
		::Ice::Context::const_iterator i = current.ctx.find("secret");
		ok = ok && (i != current.ctx.end());
		if (ok) {
			const QString &secret = u8((*i).second);
...
#endif // ACCESS_Server_getListenerVolumeAdjustment_ALL

	ExecEvent *ie = new ExecEvent(boost::bind(&impl_Server_getListenerVolumeAdjustment, cb, QString::fromStdString(current.id.name).toInt(), p1, p2));
	QCoreApplication::instance()->postEvent(mi, ie);
}

void ::MumbleServer::ServerI::setListenerVolumeAdjustment_async(const ::MumbleServer::AMD_Server_setListenerVolumeAdjustmentPtr &cb, ::Ice::Int p1, ::Ice::Int p2, ::Ice::Float p3, const ::Ice::Current &current) {
	// qWarning() << "setListenerVolumeAdjustment" << meta->mp.qsIceSecretRead.isNull() << meta->mp.qsIceSecretRead.isEmpty();
#ifndef ACCESS_Server_setListenerVolumeAdjustment_ALL
#	ifdef ACCESS_Server_setListenerVolumeAdjustment_READ
	if (!meta->mp.qsIceSecretRead.isNull()) {
		bool ok = !meta->mp.qsIceSecretRead.isEmpty();
#	else
	if (!meta->mp.qsIceSecretRead.isNull() || !meta->mp.qsIceSecretWrite.isNull()) {
		bool ok = !meta->mp.qsIceSecretWrite.isEmpty();
#	endif // ACCESS_Server_setListenerVolumeAdjustment_READ
		::Ice::Context::const_iterator i = current.ctx.find("secret");
		ok = ok && (i != current.ctx.end());
		if (ok) {
			const QString &secret = u8((*i).second);
...
#endif // ACCESS_Server_setListenerVolumeAdjustment_ALL

	ExecEvent *ie = new ExecEvent(boost::bind(&impl_Server_setListenerVolumeAdjustment, cb, QString::fromStdString(current.id.name).toInt(), p1, p2, p3));
	QCoreApplication::instance()->postEvent(mi, ie);
}

void ::MumbleServer::ServerI::sendWelcomeMessage_async(const ::MumbleServer::AMD_Server_sendWelcomeMessagePtr &cb, const IdList& p1, const ::Ice::Current &current) {
...
void ::MumbleServer::MetaI::getServer_async(const ::MumbleServer::AMD_Meta_getServerPtr &cb, ::Ice::Int p1, const ::Ice::Current &current) {
...
void ::MumbleServer::MetaI::newServer_async(const ::MumbleServer::AMD_Meta_newServerPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::MetaI::getBootedServers_async(const ::MumbleServer::AMD_Meta_getBootedServersPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::MetaI::getAllServers_async(const ::MumbleServer::AMD_Meta_getAllServersPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::MetaI::getDefaultConf_async(const ::MumbleServer::AMD_Meta_getDefaultConfPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::MetaI::getVersion_async(const ::MumbleServer::AMD_Meta_getVersionPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::MetaI::addCallback_async(const ::MumbleServer::AMD_Meta_addCallbackPtr &cb, const MetaCallbackPrx& p1, const ::Ice::Current &current) {
	// qWarning() << "addCallback" << meta->mp.qsIceSecretRead.isNull() << meta->mp.qsIceSecretRead.isEmpty();
...
void ::MumbleServer::MetaI::removeCallback_async(const ::MumbleServer::AMD_Meta_removeCallbackPtr &cb, const MetaCallbackPrx& p1, const ::Ice::Current &current) {
	// qWarning() << "removeCallback" << meta->mp.qsIceSecretRead.isNull() << meta->mp.qsIceSecretRead.isEmpty();
...
void ::MumbleServer::MetaI::getUptime_async(const ::MumbleServer::AMD_Meta_getUptimePtr &cb, const ::Ice::Current &current) {
	// qWarning() << "getUptime" << meta->mp.qsIceSecretRead.isNull() << meta->mp.qsIceSecretRead.isEmpty();
...
void ::MumbleServer::MetaI::getSliceChecksums_async(const ::MumbleServer::AMD_Meta_getSliceChecksumsPtr &cb, const ::Ice::Current &current) {
...
void ::MumbleServer::MetaI::getSlice_async(const ::MumbleServer::AMD_Meta_getSlicePtr &cb, const Ice::Current&) {
